...
//     constructor(private starsService: Repositories.StarsRepository) {
//     }
...
//         const directive = (starsService: Repositories.StarsRepository) => new StarsAutocompleteDirective(starsService);
//         directive.$inject = ['StarsService'];
//         return directive;
//     }
// }

// myApp.directive('starsAutocomplete', ['StarsService', StarsAutocompleteDirective.factory()]);